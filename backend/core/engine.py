...
from backend.core.scripting import LuaEngine
...
class Engine:
    def __init__(self):
        ...
        self.lua = LuaEngine(self.registry, self.event_bus)
        self._running = False
    ...
    async def start(self) -> None:
        ...
        if self.lua._script:
            await self.lua.start(interval=self._config.get("settings", {}).get("script_interval", 1.0))
